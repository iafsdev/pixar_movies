# Pixar Movies guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `pixar_movies/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `pixar_movies` folder and use the modules inside your notebooks :
...
```python
from pixar_movies.utils.paths import data_dir
data_dir()
```
